            ...
            <Content>
                <Card>
                    <div style={{borderRadius: '1rem', overflow: 'hidden', width: '10rem', height: '10rem', margin: '0 auto' }}>
                        <Image height={180} src={ImgCard1} alt={"Pessoas dançando em uma festa"} objectFit="cover" />
                    </div>
                ...
                <Card>
                    <div style={{borderRadius: '1rem', overflow: 'hidden', width: '10rem', height: '10rem', margin: '0 auto' }}>
                        <Image height={180} src={ImgCard2} alt={"Imagem de um velório"} objectFit="cover" />
                    </div>
                ...
                <Card>
                    <div style={{borderRadius: '1rem', overflow: 'hidden', width: '10rem', height: '10rem', margin: '0 auto' }}>
                        <Image height={180} src={ImgCard3} alt={"Celular escaneando um QR-Code"} objectFit="cover" />
                    </div>
                    <h1>QR Code</h1>
                    <br />
